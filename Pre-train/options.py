...
def parse_common_args(parser):
    ...
    parser.add_argument('--load_model_path', type=str, default='/test.pth',help='model path for pretrain or test')
...
def parse_train_args(parser):
    ...
    parser.add_argument('--batch_size', type=int, default=512)#50
