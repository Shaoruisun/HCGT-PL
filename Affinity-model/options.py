...
def parse_common_args(parser):
    ...
    parser.add_argument('--load_model_path', type=str, default='/Pre-train/checkpoints/pre-train.pth',help='model path for pretrain or test')
...
def parse_train_args(parser):
    ...
    parser.add_argument('--batch_size', type=int, default=256)#50
