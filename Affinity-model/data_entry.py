...
data_dir='pdbbind_v2016'
data=PDBbindDataset(ids="%s/out_id_v2016_train_homogeneous3.npy"%(data_dir),protein_ligand_1="%s/out_v2016_train_homogeneous3.bin"%(data_dir),protein_ligand_2="%s/out_v2016_train_homogeneous3.bin"%(data_dir))
train_inds, val_inds =data.train_and_test_split(valnum=1000, seed=1200)
